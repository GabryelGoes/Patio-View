...
const CarLiftAnimation: React.FC = () => (
  <div className="relative w-48 h-28 shrink-0 flex items-center justify-center mr-1 overflow-visible translate-x-[50%]">
...
const VehicleRow: React.FC<VehicleRowProps> = ({ vehicle, isHighlighted, hasAnyHighlight, isAlerting }) => {
  ...
  return (
    <div className={`
      ...
      ${colorClass}
      ${showGarantiaRing ? 'ring-4 ring-red-400 ring-offset-4 ring-offset-red-900 shadow-[0_0_0_3px_rgba(248,113,113,0.7)]' : ''}
